...
public abstract class PlatformPage extends OnekeySharePage {
	...
	public void onCreate() {
		...
		llPanel.setBackgroundDrawable(new ColorDrawable(0xffffffff));
		...
		int resId = com.mob.tools.utils.R.getBitmapRes(activity,"ssdk_oks_classic_" + "cancel");
		if (resId > 0) {
		...
		resId = com.mob.tools.utils.R.getBitmapRes(getContext(), "classic_platform_corners_bg");
		if (resId > 0) {
